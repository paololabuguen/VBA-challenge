...
Sub module_2_challenge()
    ...
    For Each cur_sheet In Worksheets
        ...
        'Define Variables
        Dim ticker As String  'This is the variable for the current ticker
    
        'Loop Variables
        Dim t_check As String  'This is the variable to check for the next tickers
        Dim ind1 As Long       'Index for the data table
        ...
        While IsEmpty(cur_sheet.Cells(ind1, 1)) = False
            ...
            Else
                ...
                cur_sheet.Cells(ind2, 10).Interior.ColorIndex = 16
            End If

            ind2 = ind2 + 1 'Next index for the subsheet row
        Wend
    
        'Change column size to fit the values in the cells
        cur_sheet.Columns("I:R").AutoFit
